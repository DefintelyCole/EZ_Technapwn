...
void RedWP() {
  ...
  // chassis.pid_drive_set(60, 75, true);
  ...
  // chassis.pid_wait();
  // chassis.pid_wait();
  // chassis.pid_swing_set(ez::RIGHT_SWING,-150_deg,80);
  // // intake.move(0);
  // chassis.pid_wait();
  // // intake.move(127);
  ...
  // chassis.pid_wait_quick_chain();
  // chassis.pid_drive_set(51, 100, true);
  // chassis.pid_wait();
...
void RedSigWP() {
  ...
  // chassis.pid_wait_quick_chain();
  // pros::delay(500);
  // chassis.pid_swing_set(ez::RIGHT_SWING,-155_deg,80);
  // pros::delay(200);
  // intaketop.move(0);
  // pros::delay(600);
  // intaketop.move(127);
  ...
  Rdoinker.set_value(1);
  pros::delay(200);
  chassis.pid_swing_set(ez::LEFT_SWING,-80_deg,80);
  chassis.pid_wait_quick_chain();
  pros::delay(400);
...
chassis.pid_wait();
chassis.pid_drive_set(65_in, 80, true);
pros::delay(1500);
nextstate();
chassis.pid_wait();
...
void BlueWP() {
  ...
  chassis.pid_turn_set(40,80);
  chassis.pid_wait();
  chassis.pid_drive_set(19, 100, true);
  chassis.pid_wait();
  ...
  chassis.pid_drive_set(20, 100, true);
  chassis.pid_wait_quick_chain();
  chassis.pid_wait();chassis.pid_turn_set(-64,80);
  scoop.set_value(1);
  chassis.pid_wait();
  ...
  // chassis.pid_wait();
  // chassis.pid_wait();
  // chassis.pid_swing_set(ez::RIGHT_SWING,-145_deg,80);
  // // intake.move(0);
  // chassis.pid_wait();
  // // intake.move(127);
  // chassis.pid_drive_set(14, 50, true);
  // chassis.pid_wait();
  // chassis.pid_turn_set(-63,80);
  // scoop.set_value(1);
  // chassis.pid_wait();
  // chassis.pid_drive_set(37, 100, true);
  // pros::delay(900);
...
void Blue6Ring() {
  ...
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set(20, 100, true);
  chassis.pid_wait();chassis.pid_turn_set(-68,80);
  scoop.set_value(1);
  chassis.pid_wait();
  chassis.pid_drive_set(37, 100, true);
  pros::delay(1200);
  ...
  // scoop.set_value(1);
  // chassis.pid_wait();
  // chassis.pid_drive_set(37, 127, true);
  // pros::delay(1200);
  // chassis.pid_turn_set(90,80);
  // pros::delay(1000);
  // chassis.pid_turn_set(168,80);
  // chassis.pid_wait();
  // scoop.set_value(0);
  // chassis.pid_drive_set(47, 100, true);
  // pros::delay(500);
  // ring_rush.set_value(1);
  // pros::delay(500);
  // ring_rush.set_value(0);
...
void Skills() {
  ...
  // pros::delay(400);
  // chassis.pid_swing_set(ez::LEFT_SWING,180_deg,127);
  // pros::delay(400);
  ...
  // chassis.pid_turn_set(65,80);
  // chassis.pid_wait();
  // chassis.pid_drive_set(53, 100, true);
  // chassis.pid_wait();
  // chassis.pid_turn_set(78,80);
  // chassis.pid_wait();
  // chassis.pid_drive_set(-15, 100, true);
  // pros::delay(700);
  // chassis.pid_turn_set(0,80);
  ...
  // nextstate();
  // intake.move(127);
  // chassis.pid_drive_set(55, 40, true);
  // chassis.pid_wait();
  // chassis.pid_turn_set(45,80);
  // chassis.pid_wait();
  // chassis.pid_drive_set(15, 100, true);
  ...
  // chassis.pid_turn_set(0,80);
  // chassis.pid_wait();
  // chassis.pid_drive_set(-35, 40, true);
  // chassis.pid_wait();
  // pros::delay(200);
  // Mogo_mech.set_value(1);
  // intake.move(127);
