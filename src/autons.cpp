...
void RedSigWP() {
  ...
  chassis.pid_wait();
  scoop.set_value(0);
  chassis.pid_drive_set(52, 80, true);
  pros::delay(500);
...
void Skills() {
  ...
  pros::delay(400);
  chassis.pid_drive_set(-18, 60, true);
  pros::delay(1000);
  Mogo_mech.set_value(1);
  nextstate();
  pros::delay(400);
  ...
  chassis.pid_wait();
  chassis.pid_drive_set(-63, 100, true);
  chassis.pid_wait();
  chassis.pid_drive_set(-16, 40, true);
  chassis.pid_wait();
  pros::delay(200);
  Mogo_mech.set_value(1);
  intake.move(127);
  ...
  chassis.pid_wait();
  chassis.pid_drive_set(-40, 50, true);
  chassis.pid_wait();
  chassis.pid_turn_set(165,80);
  chassis.pid_wait();
  chassis.pid_drive_set(50, 100, true);
