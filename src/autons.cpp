...
void Red4RingWP() {
  ...
  chassis.odom_xyt_set(0_in, 0_in, 257_deg);
  ...
  pros::delay(100);
  // chassis.pid_wait_quick_chain();
  // chassis.pid_swing_set(ez::RIGHT_SWING, 100,127);
  // pros::delay(400);
...
void RedGoal(){
  ...
  chassis.pid_turn_set(190,127);
  chassis.pid_wait_quick_chain();
  chassis.pid_drive_set(100, 100, true);
  chassis.pid_wait_quick_chain();
...
void RedWP_Pos() {
  ...
  chassis.odom_xyt_set(0_in, 0_in, 283_deg);
  chassis.pid_drive_set(10_in, DRIVE_SPEED, true);
  pros::delay(200);
  nextstate();
  nextstate();
  ...
  chassis.pid_drive_set(-20, 100, true);
  chassis.pid_wait();
  chassis.pid_turn_set(308,80);
  pros::delay(500);
  Rdoinker.set_value(1);
  pros::delay(200);
  chassis.pid_turn_set(294,80);
  pros::delay(200);
  chassis.pid_drive_set(-15, 50, true);
  chassis.pid_wait();
  pros::delay(5);
...
void BlueWP_Pos() {
  ...
  chassis.odom_theta_flip();
  chassis.odom_xyt_set(0_in, 0_in, 77_deg);
  chassis.pid_drive_set(10_in, DRIVE_SPEED, true);
  pros::delay(200);
  nextstate();
  nextstate();
  ...
  chassis.pid_drive_set(-20, 100, true);
  chassis.pid_wait();
  chassis.pid_turn_set(-52,80);
  pros::delay(500);
  Ldoinker.set_value(1);
  pros::delay(200);
  chassis.pid_turn_set(-66,80);
  pros::delay(200);
  chassis.pid_drive_set(-15, 50, true);
  chassis.pid_wait();
  pros::delay(5);
